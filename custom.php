        ...
        <div class="col-lg-8">
          ...
          <div class="bs-component">
            ...
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
              <button type="button" class="btn btn-purple">Purple</button>
              <div class="btn-group" role="group">
                <button id="btnGroupDrop4" type="button" class="btn btn-purple dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="bs-component">
            ...
            <p class="text-purple">Fusce dapibus, tellus ac cursus commodo, tortor mauris nibh.</p>
          </div>
        </div>
      </div>
      <!-- Blockquotes -->
    ...
    <div class="bs-docs-section">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="bs-component">
            <div class="alert alert-dismissible alert-purple">
              <button type="button" class="close" data-dismiss="alert">×</button>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="bs-component">
            ...
            <div class="progress">
              <div class="progress-bar progress-bar-striped bg-purple" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="bs-component">
            ...
            <div class="card text-white bg-purple mb-3" style="max-width: 20rem;">
              <div class="card-header">Header</div>
              <div class="card-body">
                <h4 class="card-title">Purple card title</h4>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              </div>
            </div>
        ...
        <div class="col-lg-4">
          <div class="bs-component">
            ...
            <div class="card border-purple mb-3" style="max-width: 20rem;">
              <div class="card-header">Header</div>
              <div class="card-body">
                <h4 class="card-title">Purple card title</h4>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
